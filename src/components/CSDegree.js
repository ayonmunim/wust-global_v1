...
const PROGRAM_CONTENT = {
  ...
  outcomes: [
    ...
    "Apply cybersecurity tools, standards, and procedures effectively",
    "Secure wired and wireless network architecture",
    "Design and manage organizational security strategies",
    "Evaluate and recommend appropriate security technologies",
    "Communicate technical security concepts to diverse audiences"
  ],
  careers: [
  ...
  whyWust: [
    { 
      title: "#20 National Rank", 
      desc: "Ranked #20 for Cybersecurity among all universities in the USA.", 
      icon: TrendingUp, 
      color: "blue" 
    },
    { 
      title: "$5,000 Graduate Benefit", 
      desc: "Receive $5,000 worth of industry-ready training courses free after graduation.", 
      icon: DollarSign, 
      color: "blue" 
    },
    { 
      title: "Practical Sessions", 
      desc: "Hands-on, lab-based sessions simulating real-world cyber attack scenarios.", 
      icon: Zap, 
      color: "blue" 
    },
    { 
      title: "Expert Faculty", 
      desc: "Learn from industry veterans and researchers at the forefront of defense tech.", 
      icon: Users, 
      color: "blue" 
    },
  ]
            ...
            <section ref={(el) => (sectionsRef.current['focus'] = el)} className="p-8 sm:p-12 lg:p-24 bg-slate-50 scroll-mt-20">
              <div className="max-w-5xl mx-auto">
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-blue-950 uppercase tracking-tight">Program Focus</h2>
                </div>
            ...
            <section ref={(el) => (sectionsRef.current['outcomes'] = el)} className="bg-blue-950 text-white scroll-mt-20">
              <div className="grid lg:grid-cols-2">
                ...
                <div className="relative min-h-[500px] lg:h-auto overflow-hidden group order-2 lg:order-1">
                  ...
                  <div className="absolute bottom-8 sm:bottom-12 left-6 sm:left-12 right-6 sm:right-12 bg-white/10 backdrop-blur-md border border-white/20 p-4 sm:p-6 shadow-2xl">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div>
                        <p className="text-[10px] sm:text-xs text-blue-200 uppercase tracking-widest font-bold">Alumni Success</p>
                        <p className="text-base sm:text-xl font-bold text-white">Graduates employed in top Tech & Defense firms.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8 sm:p-12 lg:p-20 flex flex-col justify-center order-1 lg:order-2 bg-blue-900/30">
                  ...
                  <p className="text-base sm:text-lg text-blue-200 mb-8 leading-relaxed">
                    Upon completion, you'll have comprehensive expertise across all domains of cybersecurity.
                  </p>
              ...
              <div className="border-t border-blue-800">
                <div className="p-8 sm:p-12 lg:p-20 max-w-5xl mx-auto">
                  ...
                  <h2 className="text-3xl sm:text-4xl font-bold mb-4 leading-tight">Prepared for Industry Demands</h2>
                  <p className="text-base sm:text-lg text-blue-200 mb-10 leading-relaxed max-w-3xl">
                    Students are prepared to sit for industry-standard certifications (CISSP, CISM, CEH) and step into mid-to-senior level roles.
                  </p>
                  ...
                  <div className="md:col-span-2 relative group cursor-pointer h-80 md:h-full">
                    ...
                    <div className="relative z-10 h-full w-full bg-slate-200 border-2 border-blue-950 overflow-hidden transition-transform duration-300 group-hover:-translate-x-2 group-hover:-translate-y-2">
                      ...
                      <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-blue-950/90 via-blue-950/60 to-transparent p-6 sm:p-8">
                         ...
                         <h3 className="text-white text-2xl sm:text-3xl font-bold">A Global Community</h3>
                      ...
                      <div className="relative z-10 h-full w-full bg-white border-2 border-blue-950 overflow-hidden transition-transform duration-300 group-hover:-translate-x-1 group-hover:-translate-y-1">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-blue-950/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                           <div className="text-center">
                             <Zap className="mx-auto text-blue-400 mb-2" size={32} />
                             <h4 className="text-white font-bold text-lg sm:text-xl uppercase">Expert Faculty</h4>
                           </div>
                        </div>
                      </div>
                    </div>
